...
function Welcome() {
    return (
        <div className="WelcomeContainer float-left w-[60%] top-14 h-full flex flex-col justify-center items-start max-w-[90rem] max-h-[40rem]">
            <p className="WelcomeText text-5xl mt-[15%] text-c-text">Hi, I'm</p>
            <p className="WelcomeText text-6xl" id="NameText">Srivarshan</p>
            <p className="WelcomeText text-4xl pt-4 text-c-text">Computer Science Student</p>
            <p className="WelcomeTextPara font-jetbrains text-c-text pt-7">
